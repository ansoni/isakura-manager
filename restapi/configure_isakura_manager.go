...
//go:generate swagger generate server --target ../../isakura-manager --name IsakuraManager --spec ../swagger.yaml

func configureFlags(api *operations.IsakuraManagerAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.IsakuraManagerAPI) http.Handler {
